...
<head>
	...
	<link rel="stylesheet" href="style/style-trips.css">
...
?>			
			...
			<article>		
				...
				<div class="tripDescription col-12 col-sm-10 col-lg-6 offset-sm-1 offset-lg-3" id="tripDescription9"><h2>Półwysep Romandu</h2><p>Na tych terenach znajdują się pojedyncze bloki skalne, przypominające maczugi. Skały te są nadmierne skuwane, ponieważ można w nich znaleźć cymofan, kamień o właściwościach kosiego oka, z tego względu można dostac za niego dość dobrą cenę. Co ciekawe, więcej osób robi sobie krzywdę wykuwające te skały, niż ginie w bagnach</p><input type="button" name="wyprawy" class="button col-6 offset-3" data-trips="9" value="Rozpocznij wyprawę!"></div>
			</article>	

			<br /><br />
			
			<div id="map" class="no-gutters">
					<div class="mapTrips" data="Bagna Avatrisu" id="div1"><img src="img/div1.jpg" ></div>
					<div class="mapTrips" data="Mroczne lasy" id="div4"><img src="img/div4.jpg"></div>
					<div class="mapTrips" data="Stolica nędzy" id="div7"><img src="img/div7.jpg"></div>
					<div class="mapTrips" data="Zachodnie góry" id="div2"><img src="img/div2.jpg"></div>
					<div class="mapTrips" data="Wschodnie góry" id="div5"><img src="img/div5.jpg"></div>
					<div class="mapTrips" data="Delta Gorundy" id="div8"><img src="img/div8.jpg"></div>
					<div class="mapTrips" data="Zakazane miasto" id="div3"><img src="img/div3.jpg"></div>
					<div class="mapTrips" data="Zatoka cieni" id="div6"><img src="img/div6.jpg"></div>
					<div class="mapTrips" data="Półwysep Romandu" id="div9"><img src="img/div9.jpg"></div>
...
<?php require 'partials/footer.php'; ?>
	...
	<script src="../Minerva/javascript/trips-map.js"></script>	
		
	<!-- AJAX rozpoczęcie wyprawy -->	
		
	<script src="../Minerva/javascript/trips-ajax.js"></script>
		
	<!-- AJAX wyświetlający czas po odświeżeniu -->
		
	<script src="../Minerva/javascript/trips-ajax2.js"></script>
