...
require_once 'expeditions-data.php';

require "level-update-server.php";
require 'sessions/level-update-sessions.php';
?>
...
<?php require 'partials/footer.php'; ?>
	...
	<script src="../Minerva/javascript/expeditions-ajax.js"></script>			
	
	<!-- AJAX wyświetlający czas po odświeżeniu -->
	<script src="../Minerva/javascript/expeditions-ajax2.js"></script>	
