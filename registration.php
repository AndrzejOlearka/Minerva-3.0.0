	...
	<main>
		...
		<div class="container-fluid">
			...
			<form action="registration-server.php" method="post" class="row form_registration col-10 col-sm-10 col-lg-6 offset-1 offset-sm-1 offset-lg-3 mb-5">
				...
				<div class="registrationDone col-10 col-sm-10 col-lg-6 offset-1 offset-sm-1 offset-lg-3 mb-5"><div class='success col-12 col-sm-10 col-lg-8 offset-sm-1 offset-lg-2'>Rejestracja zakończyła się sukcesem, możesz się zalogować i grać!</div></div>
